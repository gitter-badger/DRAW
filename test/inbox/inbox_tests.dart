...
Future main() async {
  ...
  test('lib/inbox/message', () async {
    final reddit =
        await createRedditTestInstance('test/inbox/lib_inbox_message.json', live: true);
    final message = await reddit.inbox.message('t4_awl3r7');
    expect(await message.fullname, equals('t4_awl3r7'));
    expect(await message.body, equals('Hi!'));
    print((await message.replies).length);
